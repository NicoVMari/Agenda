...
public class Input{ 
    ...
    */
     ...
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento della stringa
    ...
    */
    ...
    /**
     * Legge un numero di tipo byte dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo byte inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo byte valido
     */
    ...
    */
    ...
    /**
     * Legge un numero di tipo short dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo short inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo short valido
     */
    ...
    */
    ...
    /**
     * Legge un numero di tipo int dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo int inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo int valido
     */
    ...
    */
    ...
    /**
     * Legge un numero di tipo long dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo long inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo long valido
     */
    ...
    */
    ...
    /**
     * Legge un numero di tipo float dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo float inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo float valido
     */
    ...
    */
    ...
    /**
     * Legge un numero di tipo double dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del numero
     * @return il numero di tipo double inserito dall'utente
     * @throws NumberFormatException se il valore inserito non è un numero di tipo double valido
     */
    ...
    */
     ...
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del carattere
    ...
    */
    ...
    /**
     * Legge un valore booleano dalla console.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento del valore
     * @return il valore booleano inserito dall'utente
     */
    ...
    */
    ...
    /**
     * Legge una sequenza di stringhe dalla console.
     * La sequenza viene terminata quando viene inserita una stringa vuota.
     *
     * @param prompt il messaggio da visualizzare all'utente prima della richiesta di inserimento di ogni stringa della sequenza
     * @return un array di stringhe contenente la sequenza inserita dall'utente
     */
     ...
     * La sequenza viene terminata quando viene inserita una stringa vuota.
     *
     * @param msg il messaggio da visualizzare all'utente prima della richiesta di inserimento della sequenza
     * @param prompt il messaggio da visualizzare all'utente prima della richiesta di inserimento di ogni stringa della sequenza
     * @return un array di stringhe contenente la sequenza inserita dall'utente
     */
